// Modal pour afficher le détail d'un signalement
...
function ReportPostModal(props) {
  ...
  const statusLabel = item.status ? item.status : t(lang, "reports_tag_default");
        ...
        e(
          ...
          e(
            ...
            e(
              ...
              e("span", null, t(lang, "report_modal_title"))
            ),
            e(
              "button",
              {
          ...
          e(
            ...
            item.category &&
              e("p", { className: "announcement-text" }, item.category),
            item.description &&
