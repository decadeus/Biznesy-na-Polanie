// Modal pour afficher le détail d'un événement

function EventPostModal(props) {
  ...
  const dateText = formatDate(item.date || item.createdAt);
        ...
        e(
          ...
          e(
            ...
            e(
              ...
              e("span", null, t(lang, "event_post_modal_title"))
            ),
            e(
              "button",
              {
