...
;(function () {
  const messages = {
    fr: {
      ...
      admin_nav_eventlog: "Journal d'activité",
      admin_nav_label: "Navigation admin",

      event_log_title: "Journal d'activité",
      event_log_subtitle: "Suivi des inscriptions et des publications.",
      event_log_password_label: "Mot de passe",
      event_log_password_placeholder: "Entrez le mot de passe",
      event_log_password_error: "Mot de passe incorrect.",
      event_log_unlock: "Accéder au journal",
      event_log_refresh: "Actualiser",
      event_log_loading: "Chargement du journal...",
      event_log_error_load: "Impossible de charger le journal.",
      event_log_empty: "Aucun événement pour le moment.",
      event_log_actor_unknown: "Utilisateur",
      event_log_item_signup: "{name} s'est inscrit",
      event_log_item_post: "{name} a publié {type} : {title}",
      event_log_item_unknown: "Événement",
      event_log_post_title_fallback: "sans titre",
      event_log_post_type_classifieds: "une annonce",
      event_log_post_type_events: "un événement",
      event_log_post_type_reports: "un signalement",
      event_log_post_type_services: "un service",
      event_log_post_type_polls: "un sondage",
      event_log_post_type_shops: "un commerce",
      event_log_post_type_other: "un post",
    ...
    en: {
      ...
      admin_nav_eventlog: "Activity log",
      admin_nav_label: "Admin navigation",

      event_log_title: "Activity log",
      event_log_subtitle: "Sign-ups and posts tracking.",
      event_log_password_label: "Password",
      event_log_password_placeholder: "Enter the password",
      event_log_password_error: "Incorrect password.",
      event_log_unlock: "Access log",
      event_log_refresh: "Refresh",
      event_log_loading: "Loading activity log...",
      event_log_error_load: "Unable to load the activity log.",
      event_log_empty: "No events yet.",
      event_log_actor_unknown: "User",
      event_log_item_signup: "{name} signed up",
      event_log_item_post: "{name} posted {type}: {title}",
      event_log_item_unknown: "Event",
      event_log_post_title_fallback: "no title",
      event_log_post_type_classifieds: "a listing",
      event_log_post_type_events: "an event",
      event_log_post_type_reports: "a report",
      event_log_post_type_services: "a service",
      event_log_post_type_polls: "a poll",
      event_log_post_type_shops: "a shop",
      event_log_post_type_other: "a post",
    ...
    pl: {
      ...
      admin_nav_eventlog: "Dziennik aktywności",
      admin_nav_label: "Nawigacja administracyjna",

      event_log_title: "Dziennik aktywności",
      event_log_subtitle: "Śledzenie rejestracji i publikacji.",
      event_log_password_label: "Hasło",
      event_log_password_placeholder: "Wpisz hasło",
      event_log_password_error: "Nieprawidłowe hasło.",
      event_log_unlock: "Otwórz dziennik",
      event_log_refresh: "Odśwież",
      event_log_loading: "Ładowanie dziennika...",
      event_log_error_load: "Nie udało się załadować dziennika.",
      event_log_empty: "Brak zdarzeń.",
      event_log_actor_unknown: "Użytkownik",
      event_log_item_signup: "{name} zarejestrował(a) się",
      event_log_item_post: "{name} opublikował(a) {type}: {title}",
      event_log_item_unknown: "Zdarzenie",
      event_log_post_title_fallback: "bez tytułu",
      event_log_post_type_classifieds: "ogłoszenie",
      event_log_post_type_events: "wydarzenie",
      event_log_post_type_reports: "zgłoszenie",
      event_log_post_type_services: "usługę",
      event_log_post_type_polls: "ankietę",
      event_log_post_type_shops: "sklep",
      event_log_post_type_other: "post",
